...
public class GlobalExceptionHandler  {
    ...
    @ExceptionHandler(value = MicroServiceNotWorkingException.class)
    public ResponseEntity<ErrorResponseBody> microServiceNotWorkingException(MicroServiceNotWorkingException e) {
        return new ResponseEntity<>(errorResponseService.makeResponse(e), HttpStatus.CONFLICT);
    }
}
